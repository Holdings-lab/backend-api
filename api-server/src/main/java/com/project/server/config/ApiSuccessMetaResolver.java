...
public class ApiSuccessMetaResolver {
        ...
        private static final List<ApiSuccessMetaRule> RULES = List.of(
                        ...
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/users/*/settings",
                                        "ME-SETTINGS-GET-200",
                                        "설정 조회에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.PATCH, "/api/users/*/settings/notifications",
                                        "ME-SETTINGS-NOTIFICATIONS-PATCH-200",
                                        "알림 설정이 저장되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/users/*/notifications/test",
                        ...
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/ml/users/*/sync", "ML-TRIGGER-200",
                                        "ML 파이프라인 실행에 성공했습니다."),
