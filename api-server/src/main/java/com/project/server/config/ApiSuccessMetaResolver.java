...
public class ApiSuccessMetaResolver {
    ...
    private static final List<ApiSuccessMetaRule> RULES = List.of(
            ...
            new ApiSuccessMetaRule(HttpMethod.PATCH, "/api/auth/users/*/nickname", "AUTH-NICKNAME-200",
                    "닉네임이 변경되었습니다."),
            new ApiSuccessMetaRule(HttpMethod.POST, "/api/auth/users/*/change-password", "AUTH-PASSWORD-200",
                    "비밀번호가 변경되었습니다."),
            ...
            new ApiSuccessMetaRule(HttpMethod.GET, "/api/me/settings/notifications", "ME-NOTIFICATION-GET-200",
                    "알림 설정 조회에 성공했습니다."),
            new ApiSuccessMetaRule(HttpMethod.PATCH, "/api/me/settings/notifications", "ME-NOTIFICATION-PATCH-200",
                    "알림 설정이 저장되었습니다."),
            ...
            new ApiSuccessMetaRule(HttpMethod.POST, "/admin/accounts/change-password", "ADMIN-PASSWORD-200",
                    "비밀번호가 변경되었습니다."),
            new ApiSuccessMetaRule(HttpMethod.POST, "/admin/notifications/send", "ADMIN-NOTIFICATION-SEND-200",
                    "알림이 성공적으로 전송되었습니다."),
