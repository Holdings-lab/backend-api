...
public class ApiSuccessMetaResolver {
        ...
        private static final List<ApiSuccessMetaRule> RULES = List.of(
                        ...
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/auth/refresh", "AUTH-REFRESH-200",
                                        "토큰이 갱신되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/auth/logout", "AUTH-LOGOUT-200",
                                        "로그아웃되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/auth/fcm-token", "AUTH-FCM-200",
                                        "FCM 토큰이 등록되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.PATCH, "/api/me/nickname", "AUTH-NICKNAME-200",
                                        "닉네임이 변경되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.PATCH, "/api/me/password",
                                        "AUTH-PASSWORD-200",
                                        "비밀번호가 변경되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.DELETE, "/api/me", "AUTH-DELETE-200",
                                        "회원 탈퇴가 완료되었습니다."),
                        ...
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/home/briefing", "HOME-BRIEFING-200",
                                        "홈 브리핑 조회에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/newsroom", "NEWSROOM-TAB-200",
                                        "뉴스룸 탭 조회에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/newsroom/*", "NEWSROOM-DETAIL-200",
                        ...
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/me/settings",
                                        "ME-SETTINGS-GET-200",
                                        "설정 조회에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.PATCH, "/api/me/settings/notifications",
                                        "ME-SETTINGS-NOTIFICATIONS-PATCH-200",
                                        "알림 설정이 저장되었습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/me/notifications/test",
                                        "ME-NOTIFICATION-TEST-200",
                                        "테스트 알림을 보냈습니다."),
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/watch-assets/options", "ME-ASSET-OPTIONS-200",
                                        "관심자산 옵션 조회에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/me/watch-assets", "ME-ASSET-UPDATE-200",
                                        "관심자산이 업데이트되었습니다."),

                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/ml/sync", "ML-TRIGGER-200",
                                        "ML 파이프라인 실행에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/ml/models/regression/training", "ML-TRAIN-200",
                                        "학습 실행 요청에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/ml/signal", "ML-SIGNAL-200",
                                        "시그널 예측에 성공했습니다."),
                        ...
                        new ApiSuccessMetaRule(HttpMethod.GET, "/api/onboarding/status",
                                        "ONBOARDING-STATUS-200", "온보딩 진척도 조회에 성공했습니다."),
                        new ApiSuccessMetaRule(HttpMethod.POST, "/api/onboarding/account/skip",
